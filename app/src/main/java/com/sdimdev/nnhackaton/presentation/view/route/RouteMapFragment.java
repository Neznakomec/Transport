...
import com.sdimdev.nnhackaton.di.polyclinic.DaggerPolyclinicComponent;
import com.sdimdev.nnhackaton.model.entity.polyclinic.Polyclinic;
    ...
    public void showRoute(RouteResult routeResult) {
        ...
        if (googleMap != null) {
            ...
            for (int i = 0; i < list.size(); i++) {
                Polyclinic polyclinic = list.get(i);
